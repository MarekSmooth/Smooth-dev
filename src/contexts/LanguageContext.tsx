...
const translations = {
  en: {
    ...
    'about.description': 'We are a young two-member team with a passion for modern design, a broad technical foundation, and enthusiasm for innovation in the digital world. At Smooth Development, we specialize in creating seamless digital experiences that transform businesses. With our education and practical experience in the field, we combine technical expertise with creative vision to deliver custom-tailored solutions that meet your current needs and grow alongside your business.',
