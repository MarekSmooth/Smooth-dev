...
const translations = {
  en: {
    ...
    'services.ecommerce.feature1': 'Shoptet / PrestaShop / a další',
    ...
    'about.title.crafting': 'Web Development',
    'about.title.excellence': '& IT Service in Brno',
    'about.description': 'We are a duo based in Brno, united by a passion for technology, design, and innovation. For businesses and individuals across the Czech Republic, we build custom websites, e-shops, mobile apps, and database systems that combine aesthetics, performance, and usability.\nWe have also worked with hardware for many years, so we offer IT service too: PC and laptop diagnostics and repair, upgrades, custom builds, and complete corporate PC setup.\nOur goal is for the digital world to run smoothly — just like your business.',
    ...
    'seo.about.description': 'Meet Smooth Development, a full-stack development duo based in Brno delivering websites, e-shops, and custom systems, plus PC and laptop IT service, across the Czech Republic.',
  ...
  cs: {
    ...
    // About Section
    'about.badge': 'O nás',
    'about.title.crafting': 'Vývoj webů',
    'about.title.excellence': 'a IT servis v Brně',
    'about.description': 'Jsme dvojice z Brna, kterou spojuje vášeň pro technologie, design a inovace. Firmám i jednotlivcům po celé České republice tvoříme webové stránky, e-shopy, mobilní aplikace a databázové systémy na míru, Řešení, která spojují estetiku, výkon a použitelnost.\nS hardwarem pracujeme už dlouhá léta, a proto nabízíme i IT servis: diagnostiku a opravy počítačů a notebooků, upgrady, sestavy na míru i kompletní přípravu firemních PC.\nNaším cílem je, aby digitální svět fungoval hladce, stejně jako vaše podnikání.',
    ...
    'seo.about.description': 'Poznejte Smooth Development, vývojářskou dvojici z Brna, která tvoří weby, e-shopy a systémy na míru a nabízí IT servis počítačů a notebooků pro klienty po celé ČR.',
