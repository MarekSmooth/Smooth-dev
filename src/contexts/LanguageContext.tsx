...
const translations = {
  en: {
    ...
    'about.description': 'We are a young two-member team with a sense for modern design, broad technical foundation, and passion for innovation in the digital world. With education and experience in the field, we are ready to work with clients to solve their needs with custom-tailored solutions.',
  ...
  cs: {
    ...
    'about.description': 'Jsme mladý dvoučlenný tým, který má cit pro moderní design, široký technický základ a zapálení pro inovace v digitálním světě. Máme vzdělání a praxi v oboru a jsme ochotni řešit se zákazníky jejich přání na míru.',
