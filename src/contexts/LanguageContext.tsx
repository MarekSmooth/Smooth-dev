...
const translations = {
  en: {
    ...
    'services.ecommerce.description': 'Complete e-shop development on Shoptet platform with extensive experience',
    'services.ecommerce.feature1': 'Shoptet Platform',
    'services.ecommerce.feature2': 'Custom Design',
  ...
  cs: {
    ...
    'services.ecommerce.description': 'Kompletní vývoj e-shopů na platformě Shoptet s rozsáhlými zkušenostmi',
    'services.ecommerce.feature1': 'Shoptet platforma',
    'services.ecommerce.feature2': 'Vlastní design',
